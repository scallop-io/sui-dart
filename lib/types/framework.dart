...
final SUI_RANDOM_OBJECT_ID = normalizeSuiObjectId('0x8');
final SUI_COIN_REGISTRY_OBJECT_ID = normalizeSuiObjectId('0xc');
final SUI_DENY_LIST_OBJECT_ID = normalizeSuiObjectId('0x403');
