...
class GetCoinInfoRequest extends $pb.GeneratedMessage {
  ...
  GetCoinInfoRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class GetCoinInfoResponse extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetCoinInfoResponse clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class CoinMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aE<CoinMetadata_MetadataCapState>(
        8, _omitFieldNames ? '' : 'metadataCapState',
        enumValues: CoinMetadata_MetadataCapState.values)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  CoinMetadata clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class CoinTreasury extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aE<CoinTreasury_SupplyState>(3, _omitFieldNames ? '' : 'supplyState',
        enumValues: CoinTreasury_SupplyState.values)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  CoinTreasury clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class RegulatedCoinMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aI(5, _omitFieldNames ? '' : 'variant', fieldType: $pb.PbFieldType.OU3)
    ..aE<RegulatedCoinMetadata_CoinRegulatedState>(
        6, _omitFieldNames ? '' : 'coinRegulatedState',
        enumValues: RegulatedCoinMetadata_CoinRegulatedState.values)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  RegulatedCoinMetadata clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class ListDynamicFieldsRequest extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ListDynamicFieldsRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class ListDynamicFieldsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'sui.rpc.v2'),
      createEmptyInstance: create)
    ..pPM<DynamicField>(1, _omitFieldNames ? '' : 'dynamicFields',
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ListDynamicFieldsResponse clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class DynamicField extends $pb.GeneratedMessage {
  factory DynamicField({
    ...
    $core.String? parent,
    $core.String? fieldId,
    $2.Object? fieldObject,
    $3.Bcs? name,
    $3.Bcs? value,
    $core.String? valueType,
    $core.String? childId,
    $2.Object? childObject,
  }) {
    final result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'sui.rpc.v2'),
      createEmptyInstance: create)
    ..aE<DynamicField_DynamicFieldKind>(1, _omitFieldNames ? '' : 'kind',
        enumValues: DynamicField_DynamicFieldKind.values)
    ..aOS(2, _omitFieldNames ? '' : 'parent')
    ..aOS(3, _omitFieldNames ? '' : 'fieldId')
    ..aOM<$2.Object>(4, _omitFieldNames ? '' : 'fieldObject',
        subBuilder: $2.Object.create)
    ..aOM<$3.Bcs>(5, _omitFieldNames ? '' : 'name', subBuilder: $3.Bcs.create)
    ..aOM<$3.Bcs>(6, _omitFieldNames ? '' : 'value', subBuilder: $3.Bcs.create)
    ..aOS(7, _omitFieldNames ? '' : 'valueType')
    ..aOS(8, _omitFieldNames ? '' : 'childId')
    ..aOM<$2.Object>(9, _omitFieldNames ? '' : 'childObject',
        subBuilder: $2.Object.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  DynamicField clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(4)
  $2.Object get fieldObject => $_getN(3);
  @$pb.TagNumber(4)
  set fieldObject($2.Object value) => $_setField(4, value);
  @$pb.TagNumber(4)
  $core.bool hasFieldObject() => $_has(3);
  @$pb.TagNumber(4)
  void clearFieldObject() => $_clearField(4);
  @$pb.TagNumber(4)
  $2.Object ensureFieldObject() => $_ensure(3);

  /// The dynamic field's "name"
  @$pb.TagNumber(5)
  $3.Bcs get name => $_getN(4);
  @$pb.TagNumber(5)
  set name($3.Bcs value) => $_setField(5, value);
  @$pb.TagNumber(5)
  $core.bool hasName() => $_has(4);
  @$pb.TagNumber(5)
  void clearName() => $_clearField(5);
  @$pb.TagNumber(5)
  $3.Bcs ensureName() => $_ensure(4);

  /// The dynamic field's "value"
  @$pb.TagNumber(6)
  $3.Bcs get value => $_getN(5);
  @$pb.TagNumber(6)
  set value($3.Bcs value) => $_setField(6, value);
  @$pb.TagNumber(6)
  $core.bool hasValue() => $_has(5);
  @$pb.TagNumber(6)
  void clearValue() => $_clearField(6);
  @$pb.TagNumber(6)
  $3.Bcs ensureValue() => $_ensure(5);
  ...
  @$pb.TagNumber(9)
  $2.Object get childObject => $_getN(8);
  @$pb.TagNumber(9)
  set childObject($2.Object value) => $_setField(9, value);
  @$pb.TagNumber(9)
  $core.bool hasChildObject() => $_has(8);
  @$pb.TagNumber(9)
  void clearChildObject() => $_clearField(9);
  @$pb.TagNumber(9)
  $2.Object ensureChildObject() => $_ensure(8);
}
...
class ListOwnedObjectsRequest extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ListOwnedObjectsRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class ListOwnedObjectsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'sui.rpc.v2'),
      createEmptyInstance: create)
    ..pPM<$2.Object>(1, _omitFieldNames ? '' : 'objects',
        subBuilder: $2.Object.create)
    ..a<$core.List<$core.int>>(
        2, _omitFieldNames ? '' : 'nextPageToken', $pb.PbFieldType.OY)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ListOwnedObjectsResponse clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
