...
class Argument extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aE<Argument_ArgumentKind>(1, _omitFieldNames ? '' : 'kind',
        enumValues: Argument_ArgumentKind.values)
    ..aI(2, _omitFieldNames ? '' : 'input', fieldType: $pb.PbFieldType.OU3)
    ..aI(3, _omitFieldNames ? '' : 'result', fieldType: $pb.PbFieldType.OU3)
    ..aI(4, _omitFieldNames ? '' : 'subresult', fieldType: $pb.PbFieldType.OU3)
