...
class Package extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pPM<TypeOrigin>(5, _omitFieldNames ? '' : 'typeOrigins',
        subBuilder: TypeOrigin.create)
    ..pPM<Linkage>(6, _omitFieldNames ? '' : 'linkage',
...
class Module extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pPM<DatatypeDescriptor>(3, _omitFieldNames ? '' : 'datatypes',
        subBuilder: DatatypeDescriptor.create)
    ..pPM<FunctionDescriptor>(4, _omitFieldNames ? '' : 'functions',
...
class DatatypeDescriptor extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pPM<TypeParameter>(6, _omitFieldNames ? '' : 'typeParameters',
        subBuilder: TypeParameter.create)
    ..aE<DatatypeDescriptor_DatatypeKind>(7, _omitFieldNames ? '' : 'kind',
        enumValues: DatatypeDescriptor_DatatypeKind.values)
    ..pPM<FieldDescriptor>(8, _omitFieldNames ? '' : 'fields',
        subBuilder: FieldDescriptor.create)
    ..pPM<VariantDescriptor>(9, _omitFieldNames ? '' : 'variants',
        subBuilder: VariantDescriptor.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  DatatypeDescriptor clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class FieldDescriptor extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  FieldDescriptor clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class VariantDescriptor extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aI(2, _omitFieldNames ? '' : 'position', fieldType: $pb.PbFieldType.OU3)
    ..pPM<FieldDescriptor>(3, _omitFieldNames ? '' : 'fields',
        subBuilder: FieldDescriptor.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  VariantDescriptor clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class OpenSignatureBody extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'sui.rpc.v2'),
      createEmptyInstance: create)
    ..aE<OpenSignatureBody_Type>(1, _omitFieldNames ? '' : 'type',
        enumValues: OpenSignatureBody_Type.values)
    ..aOS(2, _omitFieldNames ? '' : 'typeName')
    ..pPM<OpenSignatureBody>(
        3, _omitFieldNames ? '' : 'typeParameterInstantiation',
        subBuilder: OpenSignatureBody.create)
    ..aI(4, _omitFieldNames ? '' : 'typeParameter',
        fieldType: $pb.PbFieldType.OU3)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  OpenSignatureBody clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class FunctionDescriptor extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aE<FunctionDescriptor_Visibility>(5, _omitFieldNames ? '' : 'visibility',
        enumValues: FunctionDescriptor_Visibility.values)
    ..aOB(6, _omitFieldNames ? '' : 'isEntry')
    ..pPM<TypeParameter>(7, _omitFieldNames ? '' : 'typeParameters',
        subBuilder: TypeParameter.create)
    ..pPM<OpenSignature>(8, _omitFieldNames ? '' : 'parameters',
        subBuilder: OpenSignature.create)
    ..pPM<OpenSignature>(9, _omitFieldNames ? '' : 'returns',
        subBuilder: OpenSignature.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  FunctionDescriptor clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class OpenSignature extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'sui.rpc.v2'),
      createEmptyInstance: create)
    ..aE<OpenSignature_Reference>(1, _omitFieldNames ? '' : 'reference',
