...
class LookupNameRequest extends $pb.GeneratedMessage {
  ...
  LookupNameRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class LookupNameResponse extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  LookupNameResponse clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class ReverseLookupNameRequest extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ReverseLookupNameRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class ReverseLookupNameResponse extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ReverseLookupNameResponse clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class NameRecord extends $pb.GeneratedMessage {
  factory NameRecord({
    ...
    $1.Timestamp? expirationTimestamp,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$1.Timestamp>(4, _omitFieldNames ? '' : 'expirationTimestamp',
  ...
  @$pb.TagNumber(4)
  $1.Timestamp get expirationTimestamp => $_getN(3);
  @$pb.TagNumber(4)
  set expirationTimestamp($1.Timestamp value) => $_setField(4, value);
  @$pb.TagNumber(4)
  $core.bool hasExpirationTimestamp() => $_has(3);
  @$pb.TagNumber(4)
  void clearExpirationTimestamp() => $_clearField(4);
  @$pb.TagNumber(4)
  $1.Timestamp ensureExpirationTimestamp() => $_ensure(3);
