...
import 'package:protobuf/well_known_types/google/protobuf/field_mask.pb.dart'
    as $3;
import 'package:protobuf/well_known_types/google/protobuf/struct.pb.dart' as $7;
...
class ExecuteTransactionRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pPM<$2.UserSignature>(2, _omitFieldNames ? '' : 'signatures',
  ...
  ExecuteTransactionRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class ExecuteTransactionResponse extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ExecuteTransactionResponse clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class SimulateTransactionRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$1.Transaction>(1, _omitFieldNames ? '' : 'transaction',
        subBuilder: $1.Transaction.create)
    ..aOM<$3.FieldMask>(2, _omitFieldNames ? '' : 'readMask',
        subBuilder: $3.FieldMask.create)
    ..aE<SimulateTransactionRequest_TransactionChecks>(
        3, _omitFieldNames ? '' : 'checks',
        enumValues: SimulateTransactionRequest_TransactionChecks.values)
    ..aOB(4, _omitFieldNames ? '' : 'doGasSelection')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  SimulateTransactionRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  @$pb.TagNumber(2)
  set readMask($3.FieldMask value) => $_setField(2, value);
  @$pb.TagNumber(2)
...
class SimulateTransactionResponse extends $pb.GeneratedMessage {
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  SimulateTransactionResponse clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
...
class CommandResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'sui.rpc.v2'),
      createEmptyInstance: create)
    ..pPM<CommandOutput>(1, _omitFieldNames ? '' : 'returnValues',
        subBuilder: CommandOutput.create)
    ..pPM<CommandOutput>(2, _omitFieldNames ? '' : 'mutatedByRef',
        subBuilder: CommandOutput.create)
    ..hasRequiredFields = false;
