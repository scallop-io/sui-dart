...
TransactionDataV1 serializeV1TransactionData(TransactionData transactionData) {
  ...
  for (var index = 0; index < len; index++) {
    ...
    if (input["Object"] != null) {
      ...
      inputs.add({
        "kind": 'Input',
        "index": index,
        "value": {"Pure": fromB64(input["Pure"]["bytes"])},
        "type": 'pure',
      });
  ...
  return TransactionDataV1(
    ...
    inputs: inputs,
    transactions: transactionData.commands?.map<Map<String, dynamic>>((
      command,
    ) {
      if (command["MakeMoveVec"] != null) {
        ...
        return {
          "kind": 'SplitCoins',
          "coin": convertTransactionArgument(
...
dynamic transactionDataFromV1(dynamic data) {
  ...
  return {
    ...
    "gasData": {
      ...
      "payment": data["gasConfig"]?["payment"]?.map(
        (ref) => ({
          "digest": ref["digest"],
    ...
    "inputs": data["inputs"]?.map((input) {
      if (input["kind"] == 'Input') {
              ...
              return {
                "Object": {
                  "ImmOrOwnedObject": {
                    ...
                    "version": value["Object"]["ImmOrOwned"]["version"]
                        ?.toString(),
              ...
              return {
                "Object": {
                  "Receiving": {
                    ...
                    "version": value["Object"]["Receiving"]["version"]
                        ?.toString(),
        ...
        if (input["type"] == 'object') {
          return {
            "UnresolvedObject": {"objectId": input["value"]?.toString()},
          };
        }

        return {
          "UnresolvedPure": {"value": input["value"]},
        };
      }
        ...
        case 'MergeCoins':
          {
            return {
              "MergeCoins": {
                "destination": parseV1TransactionArgument(
